package com.spectrasonic.MangoEconomy.providers;
...
/**
 * Proveedor de Vault Economy que permite que otros plugins usen MangoEconomy
...
public class VaultEconomyProvider implements Economy {
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer player, double amount) {
        ...
        if (economyManager.removeMoney(onlinePlayer, amount)) {
            ...
            return new EconomyResponse(amount, currentBalance, ResponseType.FAILURE, "Error al procesar la transacción.");
        }
    }
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED, "MangoEconomy no soporta bancos.");
    }
